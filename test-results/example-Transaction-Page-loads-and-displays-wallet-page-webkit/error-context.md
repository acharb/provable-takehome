...
- Name: Transaction Page >> loads and displays wallet page
- Location: /Users/aleccharbonneau/Desktop/web3-dashboardportfolio-grgltx/tests/example.spec.js:42:7
...
<launched> pid=11382
[pid=11382][err] /Users/aleccharbonneau/Library/Caches/ms-playwright/webkit-2158/pw_run.sh: line 7: 11388 Bus error: 10           DYLD_FRAMEWORK_PATH="$DYLIB_PATH" DYLD_LIBRARY_PATH="$DYLIB_PATH" "$PLAYWRIGHT" "$@"
Call log:
  - <launching> /Users/aleccharbonneau/Library/Caches/ms-playwright/webkit-2158/pw_run.sh --inspector-pipe --headless --no-startup-window
  - <launched> pid=11382
  - [pid=11382][err] /Users/aleccharbonneau/Library/Caches/ms-playwright/webkit-2158/pw_run.sh: line 7: 11388 Bus error: 10           DYLD_FRAMEWORK_PATH="$DYLIB_PATH" DYLD_LIBRARY_PATH="$DYLIB_PATH" "$PLAYWRIGHT" "$@"
